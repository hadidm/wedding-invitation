...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <!-- 
	...
	<!-- Icomoon Icon Fonts-->
	<link rel="stylesheet" href="<?= asset_url() ?>/css/icomoon.css">
	<!-- Bootstrap  -->
	...
	<!-- Modernizr JS -->
	<script src="<?= asset_url() ?>/js/modernizr-2.6.2.min.js"></script>
	<!-- FOR IE9 below -->
	<!--[if lt IE 9]>
	...
	<div id="fh5co-event" class="fh5co-bg" style="background-image:url(assets/images/pink2.jpg);">
		<div class="overlay"></div>
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box">
	...
	<!-- countTo -->
	<script src="<?= asset_url() ?>/js/jquery.countTo.js"></script>

	<!-- Stellar -->
	<script src="<?= asset_url() ?>/js/jquery.stellar.min.js"></script>
	<!-- Magnific Popup -->
	<script src="<?= asset_url() ?>/js/jquery.magnific-popup.min.js"></script>
	<script src="<?= asset_url() ?>/js/magnific-popup-options.js"></script>

	<!-- // <script src="https://cdnjs.cloudflare.com/ajax/libs/prism/0.0.1/prism.min.js"></script> -->
	<script src="<?= asset_url() ?>/js/simplyCountdown.js"></script>
	<!-- Main -->
